...
const SeedData = {
  ...
  _seedPrivateSeas() {
    ...
    const lsCustomerData = [
      { name: '上海永辉连锁超市有限公司', type: '企业客户', businessLine: '上海营销中心', productLine: '智慧商超', region: '上海', industry: '零售', status: '活跃', customerSource: '自拓线索', isBrandCustomer: '是', brandName: '永辉超市', storeCount: '101-500家', phone: '021-99887766', email: 'contact@yonghui.cn', address: '上海市闵行区虹桥商务区', tags: ['零售客户', '连锁'], privateSea: 'ls', assignee: '李春洁' },
      { name: '北京华联生活百货有限公司', type: '企业客户', businessLine: '北京营销中心', productLine: '零售SaaS', region: '北京', industry: '零售', status: '活跃', customerSource: '自拓线索', isBrandCustomer: '是', brandName: '华联生活', storeCount: '31-50家', phone: '010-88776655', email: 'info@hualianlife.cn', address: '北京市西城区金融街', tags: ['零售客户'], privateSea: 'ls', assignee: '马芙亮' },
      { name: '深圳天虹数科商业有限公司', type: '企业客户', businessLine: '深圳营销中心', productLine: '零售SaaS', region: '深圳', industry: '零售', status: '活跃', customerSource: '自拓线索', isBrandCustomer: '是', brandName: '天虹', storeCount: '51-100家', phone: '0755-88776655', email: 'biz@tianhong.cn', address: '深圳市福田区华强北', tags: ['零售客户', '重点客户'], privateSea: 'ls', assignee: '陈大业' },
      { name: '成都红旗连锁商业有限公司', type: '企业客户', businessLine: '杭州营销中心', productLine: '智慧商超', region: '成都', industry: '零售', status: '沉默', customerSource: '自拓线索', isBrandCustomer: '是', brandName: '红旗连锁', storeCount: '500家以上', phone: '028-66778899', email: 'info@hongqi.cn', address: '成都市锦江区春熙路', tags: ['零售客户'], privateSea: 'ls', assignee: '李春洁' },
      { name: '广州广百百货商业有限公司', type: '企业客户', businessLine: '广州营销中心', productLine: '新零售', region: '广州', industry: '零售', status: '活跃', customerSource: '自拓线索', isBrandCustomer: '是', brandName: '广百百货', storeCount: '11-30家', phone: '020-55667788', email: 'sales@guangbai.com', address: '广州市天河区天河路', tags: ['零售客户'], privateSea: 'ls', assignee: '马芙亮' },
    ];
